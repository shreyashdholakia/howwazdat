...
module.exports = function(app) {
  ...
  app.put('/api/profile/update', auth.ensureAuthenticated, profile.update);
  app.get('/api/profile/:username', auth.ensureAuthenticated, profile.userDetails);
  app.get('/api/profile/email/:username', profile.userEmail);
  app.post('/api/profile/image/:user', profile.profilePicture);
  ...
  app.put('/api/team/player/:teamName', team.deletePlayer);
  app.post('/api/team/clone/player/:teamName', team.clonePlayer);
  app.post('/api/user/teams/', team.userTeams);
  app.get('/api/team/matches/:teamName', team.teamMatches)
  ...
  app.post('/api/tournament/image/:tournamentName', tournament.tournamentPicture);
  ...
  app.post('/api/match/update/batting/:team', match.updateBattingScore);
  app.post('/api/match/update/bowling/:team', match.updateBowlingScore);

  var point = require('../controllers/pointController');
  app.get('/api/point/:tournament', point.show);

  var statistics = require('../controllers/statisticController');
  app.get('/api/statistics/:tournament', statistics.tournamentStats);
  app.get('/api/statistics/user/:user', statistics.userStatistics);
