...
exports.updateBattingScore = function (req, res) {
  ...
  var runs = scores.new.runs - scores.old.runs;
  var balls = scores.new.balls - scores.old.balls;
  console.log("runs " + runs);
  console.log("balls " + balls);
  Statistics.findOneAndUpdate({$and: [{'tournament': tournament}, {'teams.email': scores.old.email}]}, {
    $inc: {
      'teams.$.runs': runs,
  ...
  Team.findOneAndUpdate({$and: [{'teamName': team}, {'players.email': scores.old.email}]}, {
    $inc: {
      'players.$.runs': runs,
