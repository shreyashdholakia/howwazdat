...
exports.update = function (req, res) {
  ...
  Matches.findOne({'matchNumber': match.matchNumber}, function (err, matchDetails) {
    var homeTotal, homeOvers, visitingTotal, visitingOvers;
    if (err) {
      return next(new Error('Failed to load tournament ' + tournament));
    }
    if (matchDetails) {

      if(matchDetails.homeTeamTotal) {
        console.log(matchDetails.homeTeamTotal[0]);
      ...
      if(matchDetails.visitingTeamTotal) {
